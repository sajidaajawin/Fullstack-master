...
return (
  <div className="flex flex-wrap justify-center">
    {wishlist.map((product) => (
      <div key={product.product_id} className="w-72 h-96 bg-white shadow-md rounded-lg mx-4 mb-16">
        <img
  ...
  style={{ maxHeight: '3em', display: '-webkit-box', WebkitBoxOrient: 'vertical', WebkitLineClamp: 3 }}
>
  {product.description}
</div>

          <p className="space-x-2">
            <span className="text-2xl font-semibold text-[#C08261]">${product.price}</span>
          </p>
